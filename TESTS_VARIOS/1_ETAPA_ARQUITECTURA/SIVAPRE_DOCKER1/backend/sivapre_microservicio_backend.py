...
# =====================================================
# DATABASE CONFIG (DESDE VARIABLE DE ENTORNO)
# =====================================================
...
def recibir_reporte(reporte: ReporteCiudadano):
    ...
    try:
        ...
        print("\n=== REPORTE GUARDADO ===")
        print(f"ID DB: {nuevo.id}")
        print(f"ID APP: {nuevo.id_reporte_app}")
        print("=======================\n")

        return {
            "status": "ok",
            "id_db": nuevo.id,
            "id_reporte_app": str(nuevo.id_reporte_app)
        }
    finally:
        db.close()
